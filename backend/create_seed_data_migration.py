"""
Create a seed data migration file for Alembic
"""
import os

# Create the migration content
migration_content = '''"""Seed initial data
...
output_file = "alembic/versions/seed_initial_data.py"
with open(output_file, "w", encoding="utf-8") as f:
    f.write(migration_content)

print(f"✓ Created seed data migration: {output_file}")
print("✓ Run 'alembic upgrade head' to apply all migrations including seed data")
